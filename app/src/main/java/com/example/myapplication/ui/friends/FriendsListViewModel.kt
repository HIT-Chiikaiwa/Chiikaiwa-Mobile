...
class FriendsListViewModel(application: Application) : BaseViewModel<List<ConversationResponse>>(application) {
    ...
    private fun resolvePartnerIdAndFilter(
        ...
        viewModelScope.launch {
            val messageRepository = com.example.myapplication.data.repository.chat.MessageRepository(getApplication())
    ...
    private val blockRepository = com.example.myapplication.data.repository.social.BlockRepository(getApplication())
